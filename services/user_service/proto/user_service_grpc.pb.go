...
const (
	UserService_CreateAdminUser_FullMethodName = "/user_service.UserService/CreateAdminUser"
)
...
func (c *userServiceClient) CreateAdminUser(ctx context.Context, in *CreateAdminUserRequest, opts ...grpc.CallOption) (*CreateAdminUserResponse, error) {
...
func (UnimplementedUserServiceServer) CreateAdminUser(context.Context, *CreateAdminUserRequest) (*CreateAdminUserResponse, error) {
...
func _UserService_CreateAdminUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CreateAdminUser(ctx, req.(*CreateAdminUserRequest))
	}
